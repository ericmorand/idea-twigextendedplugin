...
public class ControllerMethodLineMarkerProvider implements LineMarkerProvider {
    ...
    private static final ExtensionPointName<ControllerActionGotoRelatedCollector> EP_NAME = new ExtensionPointName<>("com.nightlycommit.idea.twigextendedplugin.extension.ControllerActionGotoRelatedCollector");
