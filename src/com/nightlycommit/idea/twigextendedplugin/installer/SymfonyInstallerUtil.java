package com.nightlycommit.idea.twigextendedplugin.installer;
...
import com.nightlycommit.idea.twigextendedplugin.installer.dict.SymfonyInstallerVersion;
...
public class SymfonyInstallerUtil {
    ...
    public static String getDownloadVersions() {
        ...
        String userAgent = String.format("%s / %s / Symfony Plugin %s",
            ...
            PluginManager.getPlugin(PluginId.getId("com.nightlycommit.idea.twigextendedplugin")).getVersion()
        );
