package com.nightlycommit.idea.twigextendedplugin.stubs.indexes;
...
import com.nightlycommit.idea.twigextendedplugin.doctrine.DoctrineUtil;
import com.nightlycommit.idea.twigextendedplugin.doctrine.dict.DoctrineModel;
import com.nightlycommit.idea.twigextendedplugin.doctrine.dict.DoctrineModelSerializable;
import com.nightlycommit.idea.twigextendedplugin.stubs.indexes.externalizer.ObjectStreamDataExternalizer;
...
public class DoctrineMetadataFileStubIndex extends FileBasedIndexExtension<String, DoctrineModelSerializable> {
    ...
    public static final ID<String, DoctrineModelSerializable> KEY = ID.create("com.nightlycommit.idea.twigextendedplugin.doctrine_metadata");
