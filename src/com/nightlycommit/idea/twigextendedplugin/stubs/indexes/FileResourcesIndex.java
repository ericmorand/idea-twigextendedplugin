...
import com.nightlycommit.idea.twigextendedplugin.util.FileResourceVisitorUtil;
...
public class FileResourcesIndex extends FileBasedIndexExtension<String, FileResource> {
    ...
    public static final ID<String, FileResource> KEY = ID.create("com.nightlycommit.idea.twigextendedplugin.file_resources");
