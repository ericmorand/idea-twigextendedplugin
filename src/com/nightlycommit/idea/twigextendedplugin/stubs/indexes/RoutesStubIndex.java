...
import com.nightlycommit.idea.twigextendedplugin.stubs.indexes.visitor.AnnotationRouteElementWalkingVisitor;
...
public class RoutesStubIndex extends FileBasedIndexExtension<String, StubIndexedRoute> {
    ...
    public static final ID<String, StubIndexedRoute> KEY = ID.create("com.nightlycommit.idea.twigextendedplugin.routes_object");
