 ...
 *
 * @see com.nightlycommit.idea.twigextendedplugin.stubs.indexes.ContainerBuilderStubIndex
 */
public class ContainerBuilderStubIndex extends FileBasedIndexExtension<String, ContainerBuilderCall> {

    public static final ID<String, ContainerBuilderCall> KEY = ID.create("com.nightlycommit.idea.twigextendedplugin.container_builder");
