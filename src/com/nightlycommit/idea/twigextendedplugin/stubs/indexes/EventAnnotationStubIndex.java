...
import com.nightlycommit.idea.twigextendedplugin.stubs.util.EventDispatcherUtil;
...
public class EventAnnotationStubIndex extends FileBasedIndexExtension<String, DispatcherEvent> {
    ...
    public static final ID<String, DispatcherEvent> KEY = ID.create("com.nightlycommit.idea.twigextendedplugin.events_annotation");
