...
import com.nightlycommit.idea.twigextendedplugin.stubs.dict.TwigMacroTagIndex;
...
public class TwigMacroFunctionStubIndex extends FileBasedIndexExtension<String, TwigMacroTagIndex> {
    ...
    public static final ID<String, TwigMacroTagIndex> KEY = ID.create("com.nightlycommit.idea.twigextendedplugin.twig_macro_function");
