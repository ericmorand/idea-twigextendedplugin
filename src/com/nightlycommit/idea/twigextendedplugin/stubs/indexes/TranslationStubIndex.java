...
import com.nightlycommit.idea.twigextendedplugin.stubs.indexes.externalizer.StringSetDataExternalizer;
...
public class TranslationStubIndex extends FileBasedIndexExtension<String, Set<String>> {
    public static final ID<String, Set<String>> KEY = ID.create("com.nightlycommit.idea.twigextendedplugin.translations");
