package com.nightlycommit.idea.twigextendedplugin.stubs;
...
import com.nightlycommit.idea.twigextendedplugin.config.component.parser.ParameterServiceParser;
...
import com.nightlycommit.idea.twigextendedplugin.dic.XmlServiceParser;
import com.nightlycommit.idea.twigextendedplugin.dic.container.ServiceInterface;
import com.nightlycommit.idea.twigextendedplugin.dic.container.ServiceSerializable;
...
import com.nightlycommit.idea.twigextendedplugin.stubs.cache.FileIndexCaches;
import com.nightlycommit.idea.twigextendedplugin.stubs.indexes.ContainerBuilderStubIndex;
import com.nightlycommit.idea.twigextendedplugin.stubs.indexes.ContainerParameterStubIndex;
import com.nightlycommit.idea.twigextendedplugin.stubs.indexes.ServicesDefinitionStubIndex;
...
public class ContainerCollectionResolver {
    ...
    private static final ExtensionPointName<com.nightlycommit.idea.twigextendedplugin.extension.ServiceCollector> EXTENSIONS = new ExtensionPointName<>(
        "com.nightlycommit.idea.twigextendedplugin.extension.ServiceCollector"
    );
    ...
    public static class ServiceCollector {
        ...
        public Map<String, ContainerService> getServices() {
            ...
            for (com.nightlycommit.idea.twigextendedplugin.extension.ServiceCollector collectorEx : EXTENSIONS.getExtensions()) {
                if(parameter == null) {
