package com.nightlycommit.idea.twigextendedplugin.doctrine.querybuilder;
...
import com.nightlycommit.idea.twigextendedplugin.doctrine.querybuilder.dict.QueryBuilderPropertyAlias;
import com.nightlycommit.idea.twigextendedplugin.doctrine.querybuilder.dict.QueryBuilderRelation;
import com.nightlycommit.idea.twigextendedplugin.doctrine.querybuilder.processor.QueryBuilderChainProcessor;
import com.nightlycommit.idea.twigextendedplugin.doctrine.querybuilder.util.MatcherUtil;
...
public class QueryBuilderCompletionContributor extends CompletionContributor {
            ...
            private void addParameterNameCompletion(CompletionParameters completionParameters, CompletionResultSet completionResultSet, PsiElement psiElement) {
                ...
                if (matcher.find()) {
                    ...
                    Set<String> strings = new HashSet<String>() {{
                        add(complete);
                        add(com.nightlycommit.idea.twigextendedplugin.util.StringUtils.camelize(complete, true));
                    }};
                        ...
                        if(joinTable != null && StringUtils.isNotBlank(joinTable)) {
                            ...
                            if(pos > 0) {
                                ...
                                if(StringUtils.isNotBlank(aliasName)) {
                                    ...
                                    Set<String> strings = new HashSet<String>() {{
                                        add(aliasName);
                                        add(com.nightlycommit.idea.twigextendedplugin.util.StringUtils.camelize(aliasName, true));
                                        add(com.nightlycommit.idea.twigextendedplugin.util.StringUtils.underscore(aliasName));
                                    }};
    ...
    private void attachClassNames(@NotNull CompletionResultSet completionResultSet, @NotNull String repoName) {
        ...
        if(endIndex > 0) {
            ...
            String underscore = com.nightlycommit.idea.twigextendedplugin.util.StringUtils.underscore(repoName.substring(endIndex + 1, repoName.length()));
            ...
            strings.add(com.nightlycommit.idea.twigextendedplugin.util.StringUtils.camelize(strings.iterator().next(), true));
