package com.nightlycommit.idea.twigextendedplugin.doctrine.querybuilder.dbal;
...
public class DoctrineDbalQbGotoCompletionRegistrar implements GotoCompletionRegistrar {
    ...
    private static class MyDbalAliasGotoCompletionProvider extends GotoCompletionProvider {
        ...
        public Collection<LookupElement> getLookupElements() {
            ...
            aliasSet.add(value);
            aliasSet.add(com.nightlycommit.idea.twigextendedplugin.util.StringUtils.camelize(value, true));
            String underscore = com.nightlycommit.idea.twigextendedplugin.util.StringUtils.underscore(value);
            ...
            if(StringUtils.isNotBlank(this.fromAlias)) {
                aliasSet.add(com.nightlycommit.idea.twigextendedplugin.util.StringUtils.camelize(this.fromAlias + "_" + value, true));
                aliasSet.add(com.nightlycommit.idea.twigextendedplugin.util.StringUtils.underscore(this.fromAlias + "_" + value));
            }
