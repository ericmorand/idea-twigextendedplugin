package com.nightlycommit.idea.twigextendedplugin.form.util;
...
import com.nightlycommit.idea.twigextendedplugin.form.FormTypeLookup;
import com.nightlycommit.idea.twigextendedplugin.form.dict.EnumFormTypeSource;
...
import com.nightlycommit.idea.twigextendedplugin.form.FormTypeLookup;
import com.nightlycommit.idea.twigextendedplugin.form.dict.EnumFormTypeSource;
import com.nightlycommit.idea.twigextendedplugin.form.dict.FormTypeClass;
import com.nightlycommit.idea.twigextendedplugin.form.dict.FormTypeServiceParser;
                ...
                if(classReference != null && "this".equals(classReference.getName())) {
                    ...
                    if(name != null && "getBlockPrefix".equals(name)) {
                        if(phpClass.findOwnMethodByName("getBlockPrefix") != null) {
                            ...
                            return com.nightlycommit.idea.twigextendedplugin.util.StringUtils.underscore(className);
                        }
                    }
                }
