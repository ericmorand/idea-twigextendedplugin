...
import com.nightlycommit.idea.twigextendedplugin.profiler.widget.SymfonyProfilerWidget;
import com.nightlycommit.idea.twigextendedplugin.routing.RouteHelper;
import com.nightlycommit.idea.twigextendedplugin.util.IdeHelper;
import com.nightlycommit.idea.twigextendedplugin.util.service.ServiceXmlParserFactory;
...
public class Symfony2ProjectComponent implements ProjectComponent {
    ...
    private static final ExtensionPointName<ServiceContainerLoader> SERVICE_CONTAINER_POINT_NAME = new ExtensionPointName<>("com.nightlycommit.idea.twigextendedplugin.extension.ServiceContainerLoader");
