package com.nightlycommit.idea.twigextendedplugin.templating.util;
...
import com.nightlycommit.idea.twigextendedplugin.action.comparator.ValueComparator;
...
import com.nightlycommit.idea.twigextendedplugin.stubs.dict.TemplateUsage;
import com.nightlycommit.idea.twigextendedplugin.stubs.indexes.PhpTwigTemplateUsageStubIndex;
...
import com.nightlycommit.idea.twigextendedplugin.templating.TemplateLookupElement;
import com.nightlycommit.idea.twigextendedplugin.templating.TwigPattern;
import com.nightlycommit.idea.twigextendedplugin.templating.dict.*;
...
import com.nightlycommit.idea.twigextendedplugin.util.psi.PsiElementAssertUtil;
...
public class TwigUtil {
    ...
    private static final ExtensionPointName<TwigNamespaceExtension> EXTENSIONS = new ExtensionPointName<>(
            "com.nightlycommit.idea.twigextendedplugin.extension.TwigNamespaceExtension"
    );
    ...
    public static boolean isValidStringWithoutInterpolatedOrConcat(@NotNull PsiElement element) {
        ...
        if (com.nightlycommit.idea.twigextendedplugin.util.StringUtils.isInterpolatedString(templateName)) {
            return false;
        }
